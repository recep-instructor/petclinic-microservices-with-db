...
variable "sec-gr-mutual" {
  default = "petclinic-k8s-mutual-sec-group-recep"
}

variable "sec-gr-k8s-master" {
  default = "petclinic-k8s-master-sec-group-recep"
}

variable "sec-gr-k8s-worker" {
  default = "petclinic-k8s-worker-sec-group-recep"
}
...
resource "aws_security_group" "petclinic-kube-worker-sg" {
  ...
  tags = {
    Name = "kube-worker-secgroup-recep"
  }
}
...
resource "aws_security_group" "petclinic-kube-master-sg" {
  ...
  tags = {
    Name = "kube-master-secgroup-recep"
  }
}

resource "aws_iam_role" "petclinic-master-server-s3-role" {
  name               = "petclinic-master-server-role-recep"
